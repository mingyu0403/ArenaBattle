...
AABCharacter::AABCharacter()
{
	...
	{
		for (FSoftObjectPath CharacterAsset : DefaultSetting->CharacterAssets)
		{
			UE_LOG(LogClass, Warning, TEXT("Character Asset : %s"), *CharacterAsset.ToString());
		}
	}
...
void AABCharacter::SetCharacterState(ECharacterState NewState)
{
	...
	case ECharacterState::READY:
	{
		...
		if (nullptr == CharacterWidget) return;
...
float AABCharacter::TakeDamage(float DamageAmount, FDamageEvent const& DamageEvent, AController* EventInstigator, AActor* DamageCauser)
{
	...
	UE_LOG(LogClass, Warning, TEXT("Actor : %s took Damage : %f"), *GetName(), FinalDamage);
	...
	if (CurrentState == ECharacterState::DEAD)
	{
		...
		{
			AABPlayerController* PC = Cast<AABPlayerController>(EventInstigator);
			if (nullptr == PC) return 0.0f;
			PC->NPCKill(this);
		}
	}
	return FinalDamage;
...
{
	if (NewWeapon == nullptr)// && nullptr != CurrentWeapon) return;
	{
...
void AABCharacter::OnAssetLoadCompleted()
{
	...
	if (false == LoadedAssetPath.IsValid()) return;
